...
<div class="row g-4 mb-4">
    <div class="col-lg-8">
        <div class="glass-card glow-cyan h-100">
            <div class="card-header-clean">
                <h2 class="card-title-clean">
                    <i class="fas fa-chart-area text-cyan"></i>
                    <span>Adventure Engagement & Activity Timeline</span>
                </h2>
                <span class="badge bg-dark border border-secondary text-secondary small">Real-time DB</span>
            </div>
                        ...
                        <?php if (empty($recentCompletions)): ?>
                            <tr>
                                <td colspan="5" class="text-center py-4 text-muted">
                                    ...
                                    No completions logged yet in database.
                                </td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($recentCompletions as $c): ?>
                                <tr>
                                    <td>
                                        <div class="fw-bold text-light"><?= e($c['user_name'] ?? 'Adventurer') ?></div>
                                        <div class="small text-muted font-monospace"><?= substr(e($c['user_id']), 0, 8) ?>...</div>
                                    </td>
                                    <td>
                                        <div class="fw-semibold text-cyan"><?= e($c['quest_title'] ?? 'Landmark Quest') ?></div>
                                        <?= get_category_badge($c['category'] ?? 'exploration') ?>
                                    </td>
                                    <td>
